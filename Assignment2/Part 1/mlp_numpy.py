...
class MLP(object):
    def __init__(self, n_inputs, n_hidden, n_classes, leaky=False):
        """
    ...
    def forward(self, x):
        ...
        # DONE: Implement the forward pass through each layer.
    ...
    def backward(self, dout):
        ...
        """
        # DONE Implement the backward pass through each layer.
